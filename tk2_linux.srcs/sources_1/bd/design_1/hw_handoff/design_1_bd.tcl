...
proc create_root_design { parentCell } {
  ...
  set DIR_5 [ create_bd_port -dir O DIR_5 ]
  ...
  set EN_5 [ create_bd_port -dir O EN_5 ]
  ...
  set PULSE_5 [ create_bd_port -dir O PULSE_5 ]
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#USB Reset#Quad SPI Flash#GPIO#UART 0#UART 0#I2C 1#I2C 1#CAN 0#CAN 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
...
CONFIG.NUM_MI {11} \
  ...
  # Create instance: pulse_5, and set properties
  set pulse_5 [ create_bd_cell -type ip -vlnv xilinx.com:user:pulse:1.0 pulse_5 ]
...
CONFIG.NUM_PORTS {3} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins pulse_1/s00_axi]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI] [get_bd_intf_pins pulse_2/s00_axi]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI] [get_bd_intf_pins pulse_3/s00_axi]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI] [get_bd_intf_pins pulse_4/s00_axi]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI] [get_bd_intf_pins pwm_0/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI] [get_bd_intf_pins pwm_1/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI] [get_bd_intf_pins pwm_2/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M07_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M07_AXI] [get_bd_intf_pins pulse_5/s00_axi]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M09_AXI [get_bd_intf_pins axi_uartlite_1/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M10_AXI [get_bd_intf_pins axi_uartlite_2/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M10_AXI]
  ...
  connect_bd_net -net pulse_4_DIR [get_bd_ports DIR_4] [get_bd_pins pulse_4/DIR]
  connect_bd_net -net pulse_4_EN [get_bd_ports EN_4] [get_bd_pins pulse_4/EN]
  connect_bd_net -net pulse_4_PULSE [get_bd_ports PULSE_4] [get_bd_pins pulse_4/PULSE]
  connect_bd_net -net pulse_5_DIR [get_bd_ports DIR_5] [get_bd_pins pulse_5/DIR]
  connect_bd_net -net pulse_5_EN [get_bd_ports EN_5] [get_bd_pins pulse_5/EN]
  connect_bd_net -net pulse_5_PULSE [get_bd_ports PULSE_5] [get_bd_pins pulse_5/PULSE]
  ...
  connect_bd_net -net pwm_2_pwm [get_bd_ports pwm_2] [get_bd_pins pwm_2/pwm]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pulse_1/s00_axi/reg0] SEG_pulse_1_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pulse_2/s00_axi/reg0] SEG_pulse_2_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pulse_3/s00_axi/reg0] SEG_pulse_3_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pulse_4/s00_axi/reg0] SEG_pulse_4_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pulse_5/s00_axi/reg0] SEG_pulse_5_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_0/S00_AXI/S00_AXI_reg] SEG_pwm_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_1/S00_AXI/S00_AXI_reg] SEG_pwm_1_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C70000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_2/S00_AXI/S00_AXI_reg] SEG_pwm_2_S00_AXI_reg
